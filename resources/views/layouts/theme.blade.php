...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Fruitables - @yield('page-title')</title>
        ...
        <div class="container-fluid fixed-top">
                ...
                <div class="d-flex justify-content-between">
                    @auth
                        <div class="top-info ps-2">
                            {{-- <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#" class="text-white">{{Auth::user()->addresses->first()->title}}</a></small> --}}
                            <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#" class="text-white">{{Auth::user()->email}}</a></small>
                        </div>
                    @endauth
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="{{route('store')}}" class="navbar-brand"><h1 class="text-primary display-6">Fruitables</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            @auth
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="{{route('my.orders')}}" class="dropdown-item">Orders</a>
                                    <a href="{{route('addresses.index')}}" class="dropdown-item">Addreeses</a>
