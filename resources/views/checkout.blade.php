                              ...
                              <tr>
                                  <th scope="row">
                                      <div class="d-flex align-items-center mt-2">
                                          <img src="{{asset('storage/products/' . $product->images()->first()->path)}}" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                      </div>
                                  </th>
                                  <td class="py-5">{{$product->name}}</td>
                                  <td class="py-5">{{$product->price}}</td>
                                  <td class="py-5">{{$qty}}</td>
                                  <td class="py-5">{{$qty * $product->price}}</td>
                              </tr>
                                  <td class="py-5">
                                  ...
                                  <td class="py-5">
                                      <div class="py-3 border-bottom border-top">
                                          <p class="mb-0 text-dark">{{$qty * $product->price}}</p>
                                      </div>
                                  </td>
                              </tr>
                          </tbody>
