...
@section('css')
    <style>
        .pagination div nav ul.pagination {
                        ...
                        <div class="row g-4">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        @foreach ($products as $product)
                                            @if ($product->product_status == 'featured' && $product->product_show_status == 'active' && $product->category->category_status == 'active')
                                                <div class="d-flex align-items-center justify-content-start">
                                                    <div class="rounded me-4" style="width: 100px; height: 100px;">
                                                        <img src="{{asset('storage/products/'. $product->images()->first()->path)}}" class="img-fluid rounded" alt="">
                                                    </div>
                                                    <div>
                            ...
                            <div class="col-lg-9">
                                <div class="row g-4 justify-content-center">
                                    @foreach ($products as $product)
                                    @if ($product->product_show_status == 'active' && $product->category->category_status == 'active') 
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        ...
                                        @endforeach
                                    <div class="col-12">
                                        <div class="pagination d-flex justify-content-around mt-5">
